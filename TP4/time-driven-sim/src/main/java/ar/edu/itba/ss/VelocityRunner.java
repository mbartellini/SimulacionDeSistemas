...
public class VelocityRunner {
    ...
    private static final double TF = 180, DT = 0.0001, PRINT_DT = 0.01; // PRINT_DT = 0.1
    ...
    public static void main(String[] args) {
        for(int N : N_VALUES) {
            ...
            final GPCIntegrator runner = new GPCIntegrator(
                    staticFilename, dynamicFilename, N, DT, TF, (int) Math.round(PRINT_DT / DT), false
            );
            runner.run();
